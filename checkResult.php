...
<header>
    ...
    <main>
        ...
        <div class="box">
            ...
            <div class="main">
                <form class="basicInput" method="post" action="checkResultCon.php">
                ...
                <div class="element">
                        ...
                        <?php
                             ...
                             if ( isset($_GET['id']) && strlen($_GET['id']) >= 1  ) {
                                ...
                                $success = $_GET['id'];
                                echo "<script>alert('The winner is ticket number, $success')</script>";
                        ...
                        ?>
                        <label for="date">Select Date<br> </label>
                        <input type = "date" name="date" id="date">
                        <br>
                        </input>
                        <input type="submit" class = "submitbtn" name="draw" value="Check">
                    </div>
